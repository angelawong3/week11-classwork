...
// a route for a GET request that will return the content of our `terms.json` file
// which could be formatted by passing a "sort" query string

app.get("/api/terms/", (req, res) => {
  // TODO: Add a comment describing the req.query object
  // contains all the information relating to the request
